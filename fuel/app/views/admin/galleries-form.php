<div class="admin-top_links"><?php echo Html::anchor('admin', 'Dashboard').' | '.Html::anchor('admin/galleries/manage', 'Manage Galleries'); ?></div>
					...
					<div id="tab-content-info" class="tab-content">
						...
						<div class="form-row">
							...
							<div class="form-input">
								<?php echo Form::select('g_allowed_users[]', explode(',', $gallery['g_allowed_users']), $users, array('multiple'=>'true', 'id'=>'form_g_allowed_users')); ?>
								<?php echo Form::button(array('value'=>'Add New User', 'onClick'=>'document.location.href=\'/admin/users/add\'; return false;', 'id'=>'button_add_user')); ?>
							</div>
						</div>
					</div>
	...
	<div class="gallery-preview-row" id="gallery-preview-row-<?php echo $image['gi_gallery_image_id']; ?>">
							...
							<div class="details">
								...
								<?php echo Asset::img('icon_delete.png', array('onClick'=>'deleteObject(\'image\', \'/admin/galleries/delete\', \'gi_gallery_image_id='.$image['gi_gallery_image_id'].'&type=image\');', 'title'=>'Delete this image')); ?>
